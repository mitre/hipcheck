...
@pytest.mark.parametrize('opts', [options_disable_rfd9_compat, options_enable_rfd9_compat])
def test_chunking_and_query_reconstruction(opts):
    states = [(gen.QUERY_STATE_SUBMIT_IN_PROGRESS, gen.QUERY_STATE_SUBMIT_COMPLETE),
