...
///
/// This function initializes an `env_longer` which writes log messages produced via the standard `log`
/// crate macros to stdout/stderr. These plugin logs are then piped to Hipcheck core's stdout/stderr log 
